...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://app.honeyswap.org/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://app.honeyswap.org/#/swap?inputCurrency=${token0Address === '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' ? 'ETH' : token0Address
